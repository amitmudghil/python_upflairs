...
def main():
    ...
    create_ec2_button = tk.Button(action_frame, text="Create EC2 Instance", command=create_ec2_instance)
    create_s3_button = tk.Button(action_frame, text="Create S3 Bucket", command=create_s3_bucket)
    list_ec2_button = tk.Button(action_frame, text="List EC2 Instances", command=lambda: list_ec2_instances)
    list_s3_button = tk.Button(action_frame, text="List S3 Buckets", command=lambda: list_s3_buckets)
    create_sns_button = tk.Button(action_frame, text="Create SNS Topic", command=create_sns_topic)
    list_sns_button = tk.Button(action_frame, text="List SNS Topics", command=list_sns_topics)
    ...
    # Create buttons for different AWS actions
    create_ec2_button = tk.Button(action_frame, text="Create EC2 Instance", command=partial(create_ec2_instance, output_text))
    create_s3_button = tk.Button(action_frame, text="Create S3 Bucket", command=partial(create_s3_bucket, output_text))
    list_ec2_button = tk.Button(action_frame, text="List EC2 Instances", command=partial(list_ec2_instances, output_text))
    list_s3_button = tk.Button(action_frame, text="List S3 Buckets", command=partial(list_s3_buckets, output_text))
    create_sns_button = tk.Button(action_frame, text="Create SNS Topic", command=partial(create_sns_topic, output_text))
    list_sns_button = tk.Button(action_frame, text="List SNS Topics", command=partial(list_sns_topics, output_text))
